namespace EventTraceKit.Dev14
{
    ...
    internal class FontsAndColorsHelper
    {
        ...
        {
            fcStorage = Package.GetGlobalService(typeof(SVsFontAndColorStorage)) as IVsFontAndColorStorage;
        }
            ...
            Guid guid, ResourceDictionary itemValue, ColorableItemInfo[] itemInfo)
        {
            try {
                ...
                if (pInfo[0].bFaceNameValid == 1) {
                    Typeface typefaceFromFont = FontsAndColorsHelper.GetTypefaceFromFont(pInfo[0].bstrFaceName);
                ...
                Color color = FontsAndColorsHelper.GetWpfColor(itemInfo[0].crForeground);
            ...
            Guid categoryGuid, ResourceDictionary itemValue, ColorableItemInfo[] itemInfo)
        {
            try {
                ...
                Color color = FontsAndColorsHelper.GetWpfColor(itemInfo[0].crBackground);
                Brush brush = new SolidColorBrush(color);
                brush.Freeze();
