namespace EventTraceKit.EventTracing.Tests.Compilation.CodeGen
{
    ...
    public class McCodeGeneratorTest
    {
        private readonly McCodeGenOptions options = new McCodeGenOptions {
        };
        private readonly McCodeGenerator codeGenerator;

        public McCodeGeneratorTest()
        {
            codeGenerator = new McCodeGenerator(options);
        }
