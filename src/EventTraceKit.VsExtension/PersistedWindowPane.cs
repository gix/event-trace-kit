...
namespace EventTraceKit.VsExtension
{
    ...
    class PersistedWindowPane : MsVsShell.ToolWindowPane
    {
            ...
            : base(null)
        {
            ...
            ToolBar = new CommandID(Guids.guidClientCmdSet, PkgCmdId.IDM_MyToolbar);
        ...
        public override void OnToolWindowCreated()
        {
            ...
            EventTraceKitPackage package = (EventTraceKitPackage)this.Package;
            ...
            CommandID id = new CommandID(Guids.guidClientCmdSet, PkgCmdId.cmdidRefreshWindowsList);
