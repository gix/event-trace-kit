namespace EventTraceKit.VsExtension
{
    ...
    public class PresetManagerViewModel : DependencyObject
    {
        ...
        public PresetManagerViewModel(AsyncDataViewModel advModel)
        {
            ...
            HeaderDropDownMenu menu1 = new HeaderDropDownMenu {
                //ToolTip = "Select View Preset (Ctrl+P)"
            };
            PresetDropDownMenu = menu1;

            DataTableGraphTreeItem dtGti = new DataTableGraphTreeItem(advModel, advModel.Preset);
            PresetDropDownMenu.ManagementCommands.Add(PresetHeaderManagementCommand.CreatePresetSaveCommand(this, dtGti));
            PresetDropDownMenu.ManagementCommands.Add(PresetHeaderManagementCommand.CreatePresetSaveAsCommand(this, dtGti));
            PresetDropDownMenu.ManagementCommands.Add(PresetHeaderManagementCommand.CreatePresetResetCommand(this, dtGti));
            ...
            BindingOperations.SetBinding(PresetDropDownMenu, HeaderDropDownMenu.HeaderProperty, binding3);
        ...
        public PresetManagerViewModel(bool isDialogStateDirty)
        {
            IsDialogStateDirty = isDialogStateDirty;
        }
        ...
        private static readonly DependencyPropertyKey PresetColumnsPropertyKey =
            DependencyProperty.RegisterReadOnly(nameof(PresetColumns),
        ...
        private static readonly DependencyPropertyKey ConfigurablePresetColumnsPropertyKey =
            DependencyProperty.RegisterReadOnly(nameof(ConfigurablePresetColumns),
                typeof(ReadOnlyObservableCollection<PresetManagerColumnViewModel>), typeof(PresetManagerViewModel),
                new PropertyMetadata(null));
        ...
        private void HdvViewModelPropertyChangedHandler(DependencyPropertyChangedEventArgs e)
        {
            ...
            if (oldValue != null) {
                oldValue.PresetCollection.AvailablePresetsChanged -= AvailablePresetsChangedHandler;
                oldValue.PresetChanged -= PresetChangedHandler;
            }

            var newValue = (AsyncDataViewModel)e.NewValue;
            if (newValue != null) {
                newValue.PresetCollection.AvailablePresetsChanged += AvailablePresetsChangedHandler;
        ...
        private static readonly DependencyPropertyKey MangledPresetNamePropertyKey =
            DependencyProperty.RegisterReadOnly(nameof(MangledPresetName), typeof(string),
                typeof(PresetManagerViewModel), new PropertyMetadata(string.Empty, null, CoerceMangledPresetName));
        ...
        public string MangledPresetName
        {
            get
            {
                return (string)GetValue(MangledPresetNameProperty);
            }
            private set
            {
                SetValue(MangledPresetNamePropertyKey, value);
            }
        }
        ...
        public static object CoerceMangledPresetName(DependencyObject dependencyObject, object newValue)
        {
            PresetManagerViewModel model = (PresetManagerViewModel)dependencyObject;
            if (!model.IsCurrentPresetModified) {
                return model.CurrentSelectedPresetName;
            }
            object[] args = new object[] { model.CurrentSelectedPresetName };
            return string.Format(CultureInfo.CurrentCulture, "{0} *", args);
        }
        ...
        private static void OnIsCurrentSelectedPresetNameChanged(DependencyObject item, DependencyPropertyChangedEventArgs args)
        {
            item.CoerceValue(MangledPresetNameProperty);
        }
        ...
        public string CurrentSelectedPresetName
        {
            get
            {
                return (string)GetValue(CurrentSelectedPresetNameProperty);
            }
            set
            {
                SetValue(CurrentSelectedPresetNamePropertyKey, value);
            }
        }

        private void AvailablePresetsChangedHandler(object sender, EventArgs e)
        {
        ...
        private static readonly DependencyPropertyKey IsDialogStateDirtyPropertyKey =
            DependencyProperty.RegisterReadOnly(nameof(IsDialogStateDirty), typeof(bool), typeof(PresetManagerViewModel), new PropertyMetadata(
                Boxed.False, OnIsDialogStateDirtyChanged, null));
        public static readonly DependencyProperty IsDialogStateDirtyProperty =
            IsDialogStateDirtyPropertyKey.DependencyProperty;

        private static void OnIsCurrentPresetModifiedChanged(DependencyObject item, DependencyPropertyChangedEventArgs args)
        {
            item.CoerceValue(MangledPresetNameProperty);
        }
        ...
        public static readonly DependencyProperty CanApplyProperty = CanApplyPropertyKey.DependencyProperty;

        private static object CoerceCanApply(DependencyObject d, object newValue)
        {
            return Boxed.Bool(((PresetManagerViewModel)d).IsDialogStateDirty);
        }
        ...
        private static void OnIsDialogStateDirtyChanged(DependencyObject item, DependencyPropertyChangedEventArgs args)
        {
            item.CoerceValue(CanApplyProperty);
        }
    ...
    public class GraphTreeItemHeaderManagementCommand : DependencyObject
    {
        ...
        public static readonly DependencyProperty CanExecuteActionProperty = DependencyProperty.Register("CanExecuteAction", typeof(bool), typeof(GraphTreeItemHeaderManagementCommand), new PropertyMetadata(
            Boxed.Bool(false), (s, e) => ((GraphTreeItemHeaderManagementCommand)s).ExecuteCommand.RaiseCanExecuteChanged()));
        public static readonly DependencyProperty DisplayNameProperty = DependencyProperty.Register("DisplayName", typeof(string), typeof(GraphTreeItemHeaderManagementCommand), PropertyMetadataUtils.DefaultNull);
        private DelegateCommand executeCommand;
        public static readonly DependencyProperty IconUriProperty = DependencyProperty.Register("IconUri", typeof(Uri), typeof(GraphTreeItemHeaderManagementCommand), PropertyMetadataUtils.DefaultNull);
        ...
        public bool CanExecuteAction
        {
            ...
            set
            {
                SetValue(CanExecuteActionProperty, value);
            }
        }
        ...
        public DelegateCommand ExecuteCommand
        {
            get
            {
                VerifyAccess();
                if (executeCommand == null) {
                    executeCommand = new DelegateCommand(delegate (object _) {
                        Execute();
                    }, _ => CanExecuteAction);
                }
                return executeCommand;
    ...
    internal sealed class PresetHeaderManagementCommand : GraphTreeItemHeaderManagementCommand
    {
        ...
        {
            var icon = new Uri("/Microsoft.Performance.Shell;component/Resources/Preset.Reset.png", UriKind.Relative);
            var target = new PresetHeaderManagementCommand("Reset", icon, () => ResetPreset(presetManager));
            Binding binding = new Binding {
        ...
        public static void ResetPreset(PresetManagerViewModel presetManager)
        {
