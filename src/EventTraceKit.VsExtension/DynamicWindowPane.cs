namespace EventTraceKit.VsExtension
{
    ...
    class DynamicWindowPane : ToolWindowPane
    {
        ...
        public override void OnToolWindowCreated()
        {
            ...
            EventTraceKitPackage package = (EventTraceKitPackage)Package;
            ...
            var windowFrameEventsHandler = new WindowStatus(OutputWindowPane, Frame as IVsWindowFrame);
            ErrorHandler.ThrowOnFailure(((IVsWindowFrame)Frame).SetProperty(
        ...
        private IVsOutputWindowPane OutputWindowPane =>
            outputWindowPane ?? (outputWindowPane = FindOutputWindowPane());

        private IVsOutputWindowPane FindOutputWindowPane()
        {
            // First make sure the output window is visible
            IVsUIShell uiShell = (IVsUIShell)GetService(typeof(SVsUIShell));
            // Get the frame of the output window
            Guid outputWindowGuid = Guids.guidOutputWindowFrame;
            ...
            ErrorHandler.ThrowOnFailure(
                outputWindow.CreatePane(ref paneGuid, paneName, 1 /*visible=true*/, 0 /*clearWithSolution=false*/));
            // Retrieve the pane
