...
constexpr WaitTimeoutDuration InfiniteWaitTimeout{INFINITE};
...
public:
    ...
    static WaitEvent OpenOrCreate(bool initialState, bool manualReset,
...
bool WaitForAll(std::chrono::duration<Rep, Period> const& timeout, Ts const&... events)
{
...
class AutoResetEvent : public WaitEvent
{
public:
...
class ManualResetEvent : public WaitEvent
{
public:
